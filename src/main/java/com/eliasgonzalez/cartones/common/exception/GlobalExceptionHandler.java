...
public class GlobalExceptionHandler {
        ...
        public ResponseEntity<ErrorResponse> handleExcelProcessingException(
                ...
                ErrorResponse response = buildErrorResponse(
                                HttpStatus.UNPROCESSABLE_ENTITY, "Error de Procesamiento de Excel", ex.getMessage(),
                                details, request);
        ...
        public ResponseEntity<ErrorResponse> handlePdfCreationException(
                ...
                log.error(
                                ...
                                LogSanitizer.safe(ex.getMessage()),
                                ex);
                String message = isDevProfile() ? ex.getMessage()
                                : "Error generando el archivo PDF. Contacte al administrador.";
                List<String> details = isDevProfile() ? ex.getErrorDetails() : List.of();
                ErrorResponse response = buildErrorResponse(
                                HttpStatus.INTERNAL_SERVER_ERROR, "Error Interno del Servidor", message, details,
                                request);
        ...
        public ResponseEntity<ErrorResponse> handleFlagNotFoundException(
                ...
                log.warn(
                                ...
                                LogSanitizer.safe(ex.getMessage()));
                ErrorResponse response = buildErrorResponse(
                                HttpStatus.NOT_FOUND, "Flag no encontrado", ex.getMessage(), List.of(), request);
        ...
        public ResponseEntity<ErrorResponse> handleInvalidFlagValueException(
                ...
                log.warn(
                                ...
                                LogSanitizer.safe(ex.getMessage()));
                ErrorResponse response = buildErrorResponse(
                                HttpStatus.BAD_REQUEST, "Valor inválido para flag", ex.getMessage(), List.of(),
                                request);
        ...
        public ResponseEntity<ErrorResponse> handleResourceNotFoundException(
                ...
                log.error(
                                ...
                                LogSanitizer.safe(ex.getMessage()));
                ErrorResponse response = buildErrorResponse(
                                HttpStatus.NOT_FOUND, "Recurso no encontrado", ex.getMessage(), ex.getErrorDetails(),
                                request);
                return new ResponseEntity<>(response, HttpStatus.NOT_FOUND);
        }
        ...
        public ResponseEntity<ErrorResponse> handleMethodArgumentNotValidException(
                ...
                if (isDevProfile()) {
                        ex.getBindingResult()
                                        .getFieldErrors()
                                        .forEach(
                                                        error -> log.debug("Campo inválido: {} - {}", error.getField(),
        ...
        public ResponseEntity<ErrorResponse> handleAuthenticationException(
                ...
                ErrorResponse response = buildErrorResponse(HttpStatus.UNAUTHORIZED, "Error de Autenticación", message,
                                List.of(), request);
                return new ResponseEntity<>(response, HttpStatus.UNAUTHORIZED);
        }
        ...
        public ResponseEntity<ErrorResponse> handleDataIntegrityViolationException(
                ...
                ErrorResponse response = buildErrorResponse(HttpStatus.CONFLICT, "Conflicto de Integridad", message,
                                List.of(), request);
